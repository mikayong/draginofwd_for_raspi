...
void stop_clean_service(void) {
    ...
    lgw_log(LOG_INFO, "INFO~ starting service cleaning ...\n");
...
int main(int argc, char *argv[]) {
    ...
    */
	...
	printf("INFO~ [MAIN] Exiting packet forwarder program\n");
	exit(EXIT_SUCCESS);
}
...
static void thread_watchdog(void) {
	...
	lgw_log(LOG_INFO, "INFO~ [WD] End of watchdog thread\n");
}
